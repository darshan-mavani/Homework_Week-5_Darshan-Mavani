Feature: Bookcategory
  ...
  Background I should be able to see homepage
    ...
    Scenario Outline: I should be able to see top enu tabs on homepage with categories

      When I am on home page
      Then I should able to see top enu tabs with "<categories>"
